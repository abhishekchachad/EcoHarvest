...
const Products = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await axios.get("https://ecoharvestbackend-o7qka6p27-abhishekchachads-projects.vercel.app/api/products");  // Correct backend URL
  ...
  const addToCart = async (product) => {
    ...
    try {
      ...
      await axios.post("https://ecoharvestbackend-o7qka6p27-abhishekchachads-projects.vercel.app/api/cart", {
        userId,
