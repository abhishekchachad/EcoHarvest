...
const Products = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await axios.get("https://ecoharvestbackend-ek9vrg6up-abhishekchachads-projects.vercel.app.vercel.app/api/products");  // Correct backend URL
  ...
  const addToCart = async (product) => {
    ...
    try {
      ...
      await axios.post("https://ecoharvestbackend-ek9vrg6up-abhishekchachads-projects.vercel.app.vercel.app/api/cart", {
        userId,
