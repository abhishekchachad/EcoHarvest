...
const AdminPage = () => {
    ...
    const fetchProducts = async () => {
        try {
            const response = await axios.get("https://ecoharvest-backend.vercel.app/api/products");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                await axios.put(`https://ecoharvest-backend.vercel.app/api/products/${editingId}`, formData, {
                    headers: { "Content-Type": "multipart/form-data" },
                });
            } else {
                await axios.post("https://ecoharvest-backend.vercel.app/api/products", formData, {
                    headers: { "Content-Type": "multipart/form-data" },
                });
            }
    ...
    const handleEdit = (product) => {
        ...
        setPreviewImage(`https://ecoharvest-backend.vercel.app/${product.image_url}`);
    };

    const handleDelete = async (id) => {
        try {
            await axios.put(`https://ecoharvest-backend.vercel.app/api/products/delete/${id}`);
            fetchProducts();
        } catch (error) {
